...
---
*по каждому пункту полное опесание смотри в спойлерах в самом низу.*
---
...
Нужно перерисовать все картинки, которые находятся в папке `assets`, `google play`, `apple store` (другие папки не трогаем, они нужны только для справки и понимания общего контекста задания)  
